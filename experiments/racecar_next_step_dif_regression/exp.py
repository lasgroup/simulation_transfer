...
def experiment(num_train_traj: int,
    ...
    group_name = f'num_train_traj={num_train_traj}_use_sim_prior={use_sim_prior}_learn_std={learn_std}'
    NUM_TRAJECTORIES = 50
    ...
    bnn.fit(x_train, y_train, x_eval=x_test, y_eval=y_test, log_to_wandb=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--learn_std', type=int, default=0)
    parser.add_argument('--project_name', type=str, default='SimPrior')
