...
def main(args, drop_nan=False):
    ...
    df_full = df_full[df_full['data_source'] == 'pendulum_bimodal']
    ...
    different_method_plot(df_agg, metric='nll', filter_std_higher_than=10.0)
    ...
    metric = 'rmse'
    for param in ['bandwidth_score_estim', 'bandwidth_svgd', 'num_measurement_points', 'num_f_samples']:
