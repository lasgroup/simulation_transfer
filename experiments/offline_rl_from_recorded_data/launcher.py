...
_applicable_configs = {
    ...
    'num_offline_collected_transitions': [20, 50, 100, 200, 400, 800, 1600, 2000, 2500, 20_000],
    'test_data_ratio': [0.0],
    'eval_on_all_offline_data': [1],
    'eval_only_on_init_states': [1],
    'share_of_x0s_in_sac_buffer': [0.6],
    'bnn_batch_size': [32],
...
_applicable_configs_high_fidelity = {'use_sim_prior': [1],
                                     ...
                                     'high_fidelity': [1],
                                     'predict_difference': [1],
                                     'num_measurement_points': [16]} | _applicable_configs
