...
PROJECT_NAME = 'OfflineRLLikelihood0_test'
...
_applicable_configs = {
    ...
    'num_offline_collected_transitions': [400, 800, 1600, 2_000, 2_500, 3_000, 5_000, 10_000, 15_000, 20_000],
    'test_data_ratio': [0.0],
    'eval_on_all_offline_data': [1],
    'eval_only_on_init_states': [1],
    'share_of_x0s_in_sac_buffer': [0.5],
    'bnn_batch_size': [32],
    'likelihood_exponent': [1.0, 0.75, 0.5, 0.25],
}
